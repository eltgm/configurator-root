...
- [ ] User packages: package/archive/OS scripts/lifecycle contracts выполнены либо `delivery/**` не затронут
- [ ] Release supply chain: workflow/assets/checksums/image metadata contracts выполнены либо release-контур не затронут
