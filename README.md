...
типами, общим каталогом атрибутов и компонентами, переиспользование атрибутов между типами, изображения, ручные и автоматические правила совместимости, граф, прямой/
транзитивный/batch/intersection поиск, сохранение, копирование, экспорт и удаление конфигураций. Поддерживаются светлая,
тёмная и системная темы, карточки/таблица, desktop/mobile navigation и reflow от 320 CSS px.
