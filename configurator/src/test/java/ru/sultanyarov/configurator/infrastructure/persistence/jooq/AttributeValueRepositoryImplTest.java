...
class AttributeValueRepositoryImplTest extends AbstractJooqRepositoryTest {
    ...
    void shouldPersistAndReadBackAttributeValuesOfDifferentTypes() {
        List<AttributeValue> created = repository.createAttributeValues(List.of(
                ...
                AttributeValue.builder().attributeDefinitionId(3L).dataType(DataType.BOOLEAN).value("true").build()
        ), 1L);
