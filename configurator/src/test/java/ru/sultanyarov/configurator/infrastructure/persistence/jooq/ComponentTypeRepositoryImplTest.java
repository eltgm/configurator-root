...
class ComponentTypeRepositoryImplTest extends AbstractJooqRepositoryTest {
  ...
  void shouldCreateUpdateDeleteAndQueryComponentTypes() {
    ...
    dslContext
        ...
        .set(Tables.COMPONENT_TYPE_ATTRIBUTE.COMPONENT_TYPE_ID, created.id())
        .set(Tables.COMPONENT_TYPE_ATTRIBUTE.ATTRIBUTE_DEFINITION_ID, 1L)
    ...
    assertThat(fetched.attributeDefinitions().get(0).enumValues())
        .containsExactlyInAnyOrder("MX", "ALPS");
    ...
    dslContext
        .deleteFrom(Tables.COMPONENT_TYPE_ATTRIBUTE)
        .where(Tables.COMPONENT_TYPE_ATTRIBUTE.COMPONENT_TYPE_ID.eq(created.id()))
        .execute();
    dslContext
        .deleteFrom(Tables.ATTRIBUTE_DEFINITION)
        .where(Tables.ATTRIBUTE_DEFINITION.ID.eq(1L))
        .execute();
    dslContext
