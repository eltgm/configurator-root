...
class AttributeRepositoryImplTest extends AbstractJooqRepositoryTest {
    ...
    void shouldCreateUpdateDeleteAndQueryAttributes() {
        AttributeDefinition created = repository.createAttributeDefinition(AttributeDefinition.builder()
                        .componentTypeId(1L)
                        .name("stem")
                        .label("Stem")
        ...
        AttributeDefinition updated = repository.updateAttribute(created.id(), AttributeDefinition.builder()
                        .componentTypeId(1L)
                        .name("force")
                        .label("Force")
