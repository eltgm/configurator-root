...
/**
 * Outbound port for persisting and retrieving {@link ComponentType} entities.
...
public interface ComponentTypeRepository {
    ...
    /**
     * Checks whether at least one component type exists for the specified domain.
     *
     * @param domainId the unique identifier of the domain
     * @return {@code true} if at least one component type exists for the specified domain, {@code false} otherwise
     */
    boolean hasByDomainId(Long domainId);
}
