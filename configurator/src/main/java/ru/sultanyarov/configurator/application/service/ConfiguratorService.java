...
public interface ConfiguratorService {
  ...
  /**
   * Classifies active candidates for an assembly using direct pair decisions.
   *
   * @param domainId domain scope
   * @param componentIds unique active components already present in the assembly
   * @return all other active components classified as available, blocked or unrelated
   */
  ConfiguratorCandidatesResult classifyCandidates(Long domainId, List<Long> componentIds);
}
