...
/**
 * Outbound port for persisting and retrieving {@link AttributeDefinition} entities. Defines
...
public interface AttributeRepository {
   ...
   * @return {@code true} if attribute definitions exist for the component type, {@code false}
   *     otherwise
   */
  ...
  /** Retrieves catalog definitions belonging to a domain. */
   ...
   * @return {@code true} if an attribute definition with the given ID exists, {@code false}
   *     otherwise
   */
  boolean existsById(Long id);

  /** Checks that a definition belongs to a domain. */
