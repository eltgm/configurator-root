...
public class AttributesFacadeImpl implements AttributesFacade {
    ...
    @Override
    public ru.sultanyarov.configurator.api.inbounds.rest.dto.AttributeDefinition updateAttribute(Long id, CreateAttributeDefinitionRequest createAttributeDefinitionRequest) {
    ...
    @Override
    public ru.sultanyarov.configurator.api.inbounds.rest.dto.AttributeDefinition createAttribute(Long componentTypeId, CreateAttributeDefinitionRequest createAttributeDefinitionRequest) {
    ...
    @Override
    public List<ru.sultanyarov.configurator.api.inbounds.rest.dto.AttributeDefinition> getAttributesByComponentTypeId(Long componentTypeId) {
