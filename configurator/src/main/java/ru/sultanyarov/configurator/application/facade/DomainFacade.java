...
/**
 * Facade interface for domain management operations. Provides an application boundary for
 * converting transport-layer requests and responses related to {@link Domain} entities.
 */
public interface DomainFacade {
  /**
   * Creates the complete deterministic demo domain for the first-run experience.
   *
   * @return the created demo domain DTO
   */
   ...
   *     validation fails
   * @throws ru.sultanyarov.configurator.domain.exception.EntityAlreadyExistsException if a domain
