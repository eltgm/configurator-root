...
public interface CompatibilityRuleRepository {
   ...
   * @throws ru.sultanyarov.configurator.domain.exception.EntityAlreadyExistsException when the
   *     target business key already exists
   */
  ...
  /** Checks whether any rule condition references an attribute definition. */
  boolean hasByAttributeDefinitionId(Long attributeDefinitionId);
}
