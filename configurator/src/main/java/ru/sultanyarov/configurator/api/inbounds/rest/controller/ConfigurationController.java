...
public class ConfigurationController implements ConfigurationsApi {
  ...
  @Override
  public ResponseEntity<SavedConfiguration> postDomainsByIdConfigurations(
  ...
  public ResponseEntity<ConfigurationPage> getDomainsByIdConfigurations(
    ...
    return ResponseEntity.ok(
        configurationFacade.getPage(id, page, size, trackInventory, name, sortBy, sortDirection));
  }

  @Override
  public ResponseEntity<SavedConfiguration> getConfigurationsById(Long id) {
    return ResponseEntity.ok(configurationFacade.getById(id));
  }

  @Override
  public ResponseEntity<Void> deleteConfigurationsById(Long id) {
    configurationFacade.delete(id);
    return ResponseEntity.noContent().build();
  }

  @Override
  public ResponseEntity<SavedConfiguration> putConfigurationsById(
  ...
  @Override
  public ResponseEntity<ConfigurationExport> getConfigurationsByIdExportJson(Long id) {
    return ResponseEntity.ok()
