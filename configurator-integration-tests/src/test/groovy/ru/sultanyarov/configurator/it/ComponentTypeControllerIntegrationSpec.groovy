...
import ru.sultanyarov.configurator.contract.AbstractComponentTypeControllerContract
...
class ComponentTypeControllerIntegrationSpec extends AbstractComponentTypeControllerContract {
    @Autowired
    MockMvc mockMvc
