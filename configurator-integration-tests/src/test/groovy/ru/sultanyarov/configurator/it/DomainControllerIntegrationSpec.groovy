...
import ru.sultanyarov.configurator.contract.AbstractDomainControllerContract
...
class DomainControllerIntegrationSpec extends AbstractDomainControllerContract {
    @Autowired
    MockMvc mockMvc
