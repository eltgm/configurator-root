...
import ru.sultanyarov.configurator.contract.AbstractAttributesControllerContract
...
class AttributesControllerIntegrationSpec extends AbstractAttributesControllerContract {
    @Autowired
    MockMvc mockMvc
