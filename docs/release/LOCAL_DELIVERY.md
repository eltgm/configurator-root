...
2. Скачать архив своей ОС, `SHA256SUMS` и при необходимости `IMAGE_DIGESTS` из GitHub Release `v1.2.0`.
...
3. Создать annotated tag на commit из `master`: `scripts/release/start-release-tag.sh 1.2.0`.
