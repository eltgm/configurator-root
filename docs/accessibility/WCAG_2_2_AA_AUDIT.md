...
Матрица относится к `configurator-web`, задачам 9.26–9.27 и исправлениям CON1-147. Это внутренняя проверка реализации, а не внешняя
...
| 3.2.6 Последовательная помощь            | Пункт «Помощь» доступен через общую навигацию и меню интерфейса                                                                    | Shell unit tests, axe новых панелей                | покрыто      |
...
## Проверка CON1-147 (9 сентября 2026)

Выполнены 52 проверки accessibility, включая новые панели, быстрый просмотр, подтверждение отказа от изменений
и помощь. E2E проверяет клавиатурный фокус, 320 CSS px, переключение breakpoint, доступные имена и touch-targets
44 × 44 CSS px. Полный список исправлений и результатов — в
[отчёте реализации](../reviews/UI_UX_IMPLEMENTATION_2026-09-09.md). VoiceOver/NVDA и физические мобильные устройства
не проверялись; соответствующие ручные пункты матрицы остаются открытыми.
